...
cam = bpy.data.cameras.new("RealCam")
cam.lens = 70
cam_obj = bpy.data.objects.new("RealCam", cam)
bpy.context.collection.objects.link(cam_obj)
scene.camera = cam_obj

# Shot 1: Face Closeup
cam_obj.location = Vector((-1.6, -4.4, 2.7))
target_face = Vector((0.0, -2.4, 2.36))
cam_obj.rotation_euler = (target_face - cam_obj.location).to_track_quat('-Z', 'Y').to_euler()
scene.frame_set(10)
scene.render.filepath = "/Users/macbook/.gemini/antigravity-ide/brain/acb36d71-6448-4b9e-a262-8d051bcf2860/shiba_authentic_smile_face.png"
bpy.ops.render.render(write_still=True)
print("Rendered shiba_authentic_smile_face.png")
...
scene.frame_set(10)
scene.render.filepath = "/Users/macbook/.gemini/antigravity-ide/brain/acb36d71-6448-4b9e-a262-8d051bcf2860/shiba_authentic_smile_full.png"
bpy.ops.render.render(write_still=True)
print("Rendered shiba_authentic_smile_full.png")
