...
for f in range(41):
    # Retract back into head!
    # Bone local Y is pointing forward/down, so moving in local Y or local Z:
    arm.pose.bones["Eye.L"].location = Vector((0.0, 0.08, 0.0))
    ...
    arm.pose.bones["Eye.R"].location = Vector((0.0, 0.08, 0.0))
...
scene.frame_set(10)
out_img = "/Users/macbook/.gemini/antigravity-ide/brain/acb36d71-6448-4b9e-a262-8d051bcf2860/shiba_retracted_eye.png"
